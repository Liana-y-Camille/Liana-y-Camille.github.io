...
">
  <p style="font-size: 1.2em;">
    Your presence at our wedding is the greatest gift we could ask for. As you may know, we live a life full of travel and change, and we expect to move again in the coming years. Because of this, we kindly ask that gifts be mostly in the form of a monetary contribution. This will help us build new memories and adapt wherever life takes us next.
  </p>
</div>
...
<div style="display: flex; flex-direction: column; gap: 20px; max-width: 500px; margin: 40px auto;">
  ...
  " onmouseover="this.style.transform='scale(1.03)';this.style.boxShadow='0 6px 10px rgba(0,0,0,0.1)'" 
    ...
    <strong style="font-size: 1.4em;">Cash Gift</strong>
  </a>
